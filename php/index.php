...
$settingsVerif = getApplicationSettings($dbNW);
?>
<!DOCTYPE html>
<html>
        ...
        <main class="NW-accueil">
            ...
            <section class="NW-pannel mobile">
                ...
                <div class="NW-pannel-data">
                    <?php if ($settingsVerif["temp_average"] == 1) : ?>
                        <div class="NW-pannel-data__box">
                            ...
                            <div class="NW-pannel-data__box__text">
                                <span class="NW-pannel-data__box__text--title">Température</span>
                                <span class="NW-pannel-data__box__text--value"><?php echo $LastStats["recep_temp_average"]; ?>°C</span>
                            </div>
                        </div>
                    <?php endif; ?>

                    <?php if ($settingsVerif["humidity"] == 1) : ?>
                        <div class="NW-pannel-data__box">
                            <?php if ($_SESSION["DL-USER"] == "light") : ?>
                            ...
                            <div class="NW-pannel-data__box__text">
                                ...
                                <span class="NW-pannel-data__box__text--value"><?php echo $LastStats["recep_hum"]; ?>%</span>
                            </div>
                        </div>
                    <?php endif; ?>

                    <?php if ($settingsVerif["wind_direction"] == 1) : ?>
                        <div class="NW-pannel-data__box">
                            <?php if ($_SESSION["DL-USER"] == "light") : ?>
                    ...
                    <?php if ($settingsVerif["wind_speed"] == 1) : ?>
                        <div class="NW-pannel-data__box">
                            <?php if ($_SESSION["DL-USER"] == "light") : ?>
                    ...
                    <?php if ($settingsVerif["precipitation"] == 1) : ?>
                        <div class="NW-pannel-data__box">
                            <?php if ($_SESSION["DL-USER"] == "light") : ?>
                    ...
                    <?php if ($settingsVerif["precipitation_speed"] == 1) : ?>
                        <div class="NW-pannel-data__box">
                            <?php if ($_SESSION["DL-USER"] == "light") : ?>
                    ...
                    <?php if ($settingsVerif["temp_feelsLike"] == 1) : ?>
                        <div class="NW-pannel-data__box">
                            <?php if ($_SESSION["DL-USER"] == "light") : ?>
                    ...
                    <?php if ($settingsVerif["pressure"] == 1) : ?>
                        <div class="NW-pannel-data__box">
                            <?php if ($_SESSION["DL-USER"] == "light") : ?>
                    ...
                    <?php if ($settingsVerif["sunrise"] == 1) : ?>
                        <div class="NW-pannel-data__box">
                            <?php if ($_SESSION["DL-USER"] == "light") : ?>
