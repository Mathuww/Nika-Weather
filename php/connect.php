    ...
    <body>
        ...
        <main class="NW-pannelBodyPage mobile">
            ...
            <section class="connect-Space">
                <p class="connect-Space__advert subtitle"><?php
                                                            echo $signalClient;
                                                            ?></p>
                <form method="post" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI'], ENT_QUOTES); ?>" id="connect-Space__form">
                    <div class="connect-Space__form--id box-connect">
                        <label>IDENTIFIANT</label><br />
                        <input for="connect-Space__form" name="input-adminID" type="text" autofocus required maxlength=32 minlength=4 tabindex=1 placeholder="ici, votre pseudo" autocomplete="username" />
                    </div>
                    <div class="connect-Space__form--password box-connect">
                        <label>MOT DE PASSE</label><br />
                        <input for="connect-Space__form" name="input-adminPassword" type="password" required minlength=8 maxlength=72 tabindex=2 autocomplete="current-password" />
                        
                        <div class="connect-Space__form--password--eyeOpenSVG" onclick="showPassword(this)">
                        ...
                        <div class="connect-Space__form--password--eyeCloseSVG" onclick="hidePassword(this)">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <p class="connect-Space__aide subtitle">Tout identifiant et mot de passe oublié sont à négocier ou à récupérer auprès des responsables du projet Nika Weather.</p>
            </section>
